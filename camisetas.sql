...
-- Tiempo de generación: 23-01-2017 a las 19:47:52
...
CREATE TABLE `equipo` (
  `id_equipo` int(11) NOT NULL,
  `club/seleccion` enum('club','seleccion') DEFAULT NULL,
...
INSERT INTO `equipo` (`id_equipo`, `club/seleccion`, `nombre`, `pais`, `continente`, `imagen_equipo`) VALUES
(1, 'club', 'adelaide united', 'australia', 'oceania', 'link2'),
(2, '', 'aek', 'grecia', 'europa', 'link2'),
(3, '', 'ajax', 'holanda', 'europa', 'link2'),
(4, 'seleccion', NULL, 'albania', 'europa', 'link2'),
(5, 'seleccion', NULL, 'alemania', 'europa', 'link2');
